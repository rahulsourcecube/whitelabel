                        ...
                        <div class="d-flex align-items-center m-t-5 m-b-15">
                            <div class="m-l-1">
                                <span class="text-gray font-weight-semibold">Reward:
                                    <b>{{ isset($campagin_detail->reward) ?
                                        (\App\Helpers\Helper::getcurrency().$campagin_detail->reward) : '' }}</b></span>
                                <span class="m-h-5 text-gray">|</span>
                                <span class="text-gray">{{ isset($campagin_detail->task_type) ?
                                    $campagin_detail->task_type : '' }}</span>
                                <span class="m-h-5 text-gray">|</span>
                                <span class="text-gray">Expire on
                                    {{ isset($campagin_detail->expiry_date) ? $campagin_detail->expiry_date : ''
                                    }}</span>
                            </div>
                        </div>
