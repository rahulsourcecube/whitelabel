                ...
                <div class="card">
                    <div class="card-body">
                        <div class="media align-items-center">
                            ...
                            <div class="m-l-15">
                                <h2 class="m-b-0">0</h2>
                                <p class="m-b-0 text-muted">Total Referral</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="media align-items-center">
                            ...
                            <div class="m-l-15">
                                ...
                                <p class="m-b-0 text-muted">Total My Reward </p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="media align-items-center">
                            ...
                            <div class="m-l-15">
                                <h2 class="m-b-0">3</h2>
                                <p class="m-b-0 text-muted">Total Ongoing Campaigns</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="media align-items-center">
                            ...
                            <div class="m-l-15">
                                <h2 class="m-b-0">5</h2>
                                <p class="m-b-0 text-muted">Total Completed Campaigns</p>
                            </div>
                        </div>
                    </div>
                </div>
