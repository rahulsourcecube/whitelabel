    ...
    <div class="main-content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a class="btn btn-primary float-right" href="{{ route('admin.location.state.create') }}" role="button">Add New</a>
                <div>
    ...
    <script>
        ...
        $(document).ready(function() {
            var table = $('#state_table').DataTable({
                ...
                "ajax": {
                    "url": "{{ route('admin.location.state.dtlist') }}",
                    "type": "POST",
                    "headers": {
                ...
                'columnDefs': [{
...

                    {
                        ...
                        'render': function(data, type, row) {
                            ...
                            var editUrl = '{{ route('admin.location.state.edit', ':state') }}';

                            editUrl = editUrl.replace(':state', row[0]);

                            var deleteUrl = '{{ route('admin.location.state.delete', ':del') }}';
