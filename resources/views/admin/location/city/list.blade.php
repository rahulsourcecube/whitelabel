    ...
    <script>
        ...
        $(document).ready(function() {
            var table = $('#city_table').DataTable({
                ...
                "ajax": {
                    "url": "{{ route('admin.location.city.dtlist') }}",
                    "type": "POST",
                    "headers": {
                ...
                'columnDefs': [{
...

                    {
                        ...
                        'render': function(data, type, row) {
                            ...
                            var editUrl = '{{ route('admin.location.city.edit', ':city') }}';

                            editUrl = editUrl.replace(':city', row[0]);

                            var deleteUrl = '{{ route('admin.location.city.delete', ':del') }}';
