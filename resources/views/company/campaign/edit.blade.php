                ...
                <form id="taskadd" method="POST" action="{{ route('company.campaign.update', $task->id) }}"
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select name="priority" id="priority" class="form-control">
                                <option value="1" {{ !empty($task->priority) && $task->priority == 1 ? 'selected' : '' }}>High</option>
                                <option value="2" {{ !empty($task->priority) && $task->priority == 2 ? 'selected' : '' }}>Medium</option>
                                <option value="3" {{ empty($task->priority)  ? 'selected' : '' }} {{ !empty($task->priority) && $task->priority == 3 ? 'selected' : '' }}>Low</option>
                            </select>
                    ...
                    <div class="form-row">
                            ...
                            <div class="col-md-1">
                                ...
                                <div class="form-group align-items-center">
                                    <div class="switch m-r-10">
                                        <input type="checkbox" id="public-1" data-toggle="switch" name="public"  @if (isset($task->public) && $task->public == 1) checked="" @endif value="true" onclick='handleClickpublic(this)'; >
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select name="country" id="country" class="form-control">
                                    ...
                                    @foreach ($country_data as $country)
                                        <option value="{{ $country->id }}" {{!empty($task->country_id) && $task->country_id == $country->id ? 'selected' : '' }}>
                                            {{ $country->name }}</option>
                                    @endforeach
                                 @endif
                                </select>
                                ...
                                <select name="state" id="state" class="form-control">
                                    ...
                                    @if ($state_data)
                                        @foreach ($state_data as $state)
                                            <option value="{{ $state->id }}" {{  !empty($task->state_id) && $task->state_id == $state->id ? 'selected' : '' }}>
                                                {{ $state->name }}</option>
                                        @endforeach
                                     @endif
                                </select>
                                ...
                                <select name="city" id="city" class="form-control">
                                    ...
                                    @if (!empty($city_data) && !empty($state_data))
                                        @foreach ($city_data as $city)
                                            <option value="{{ $city->id }}" {{ !empty($task->city_id) && $task->city_id == $city->id ? 'selected' : '' }}>
                                                {{ $city->name }}</option>
                                        @endforeach
                                    @endif
                                </select>
