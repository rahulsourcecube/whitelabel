        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="m-t-50" style="">
                    <form id="taskadd" method="POST" action="{{ route('company.campaign.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                                ...
                                <div class="int-reward w-100">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" id="reward" name="reward" placeholder="Reward"
                                            onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="{{ old('reward') }}" min="1">
                                    </div>
                                    @error('reward')
                            ...
                            <div class="col-md-6 mt-4">
                                ...
                                <input type="checkbox" name="public" id="public" value="1" onclick='handleClick(this);'>
                            </div>
                        </div>
                ...
                @if (isset($typeInText) && $typeInText == 'Referral')
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="no_of_referral_users" name="no_of_referral_users" placeholder="No of referral users"
                            onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="{{ old('no_of_referral_users') }}" min="1">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="date" class="form-control" id="expiry_date" name="expiry_date" placeholder="No Of Task"
                        onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="{{ old('expiry_date') }}" min="{{ date('Y-m-d') }}">
                    @error('expiry_date')
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="file" class="form-control" name="image" id="file" accept=".png, .jpg, .jpeg" onchange="previewImage()" required>
                    @error('image')
