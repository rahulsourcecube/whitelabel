                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        <button class="btn btn-success" {{ $list->user_bought == true ? 'disabled' : '' }} onclick="openPaymentModal('{{ $list->id }}')">{{ $list->user_bought ? 'Purchased' : 'Buy Package' }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-6">
                                <div class="round-form-group">
                                    <label class="paymenttab-label content-para">Exp
                                        Date</label>
                                    <input type="text"
                                        class="form-control round-input remove-arrow card-expiry-month-year"
