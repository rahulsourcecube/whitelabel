                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled m-v-30">
                            ...
                            <li class="m-b-20">
                                <div class="d-flex justify-content-between"> <span
                                        class="text-dark font-weight-semibold">Total campaign {{ $list->no_of_campaign }}</span>
                                    <div class="text-success font-size-16"> <i class="anticon anticon-check"></i> </div>
                                </div>
                            </li>
                        ...
                        <div class="text-center">
                            <button class="btn btn-success {{$list->user_bought}}" {{ $list->user_bought == true ? 'disabled' : '' }}
                                onclick="openPaymentModal('{{ $list->id }}')">{{ $list->user_bought == true ? 'Purchased' : 'Buy
                                Package' }}</button>
                        </div>
                    </div>
                </div>
