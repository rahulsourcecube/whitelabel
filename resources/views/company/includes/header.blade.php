<div class="header">
    <div class="logo logo-dark">
        <a href="{{ !empty($siteSetting) && !empty($siteSetting->logo_link) ? $siteSetting->logo_link : route('company.dashboard') }} "
            ...
            <li class="dropdown dropdown-animated scale-left">
                <div class="pointer" data-toggle="dropdown">
                    <div class="avatar avatar-image  m-h-10 m-r-15">
                        ...
                        @else
                            <img src="{{ asset('uploads/user-profile/' . Auth::user()->profile_image) }}"
                                alt="">
                        @endif
                    </div>
                </div>
