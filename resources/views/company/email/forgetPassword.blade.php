...
@if (!empty($template))
    ...
    $submit = route('company.confirmPassword', $token);
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr
                                            ...
                                            <td class="content-block"
                                                style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                                valign="top">
                                                <p>We received a request to reset the password associated with this
                                                    email address. If you made this request, please click the button
                                        ...
                                        <tr
                                            ...
                                            <td class="content-block"
                                                ...
                                                <a href="{{ route('company.confirmPassword', $token) }}"
                                                    class="cta-button" itemprop="url"
                                        ...
                                        <tr>
                                            <td>
                                                <p>If you did not request to reset your password, please ignore this
                                                    email. Your password will remain unchanged.</p>
                                                <p>If you have any questions or need assistance, feel free to contact
                                                    our support team.</p>
                                            </td>
                                        </tr>
                                        <tr
