                ...
                <form id="settings" method="POST" action="{{ route("company.setting.store")}}" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control mb-2" name="cname" id="cname"
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="cemail" class="form-control mb-2" name="cemail" id="cemail"
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-1 mt-2">
                                    ...
                                    <button type="button" id="deleteImageButtons" class="btn btn-sm btn-danger mt-2"><i
