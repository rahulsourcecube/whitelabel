                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="row align-items-center">
                            <div class="text-center text-sm-left col-md-2">
                                <div class="avatar avatar-image" style="width: 150px; height:150px">
                                    @if(isset($companydetail) && $companydetail->logo == '')
                            ...
                            <div class="text-center text-sm-left m-v-15 p-l-30 col-md-4">
                                <h2 class="m-b-5">
                                    {{isset($companydetail->title)?$companydetail->title:$companyname->company_name}}
                                </h2>
                                <div class="row">
                                    <div class="d-md-block d-none border-left col-1"></div>
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <hr>
                                            <h5>Description</h5>
                                            @if(isset($companydetail->description)) {!! $companydetail->description !!}
                                            @else -
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10 " style="padding-left: 95px;">
                                        <div class="text-center text-sm-left ">
                                            ...
                                            <a href="" target="_blank">{{isset($companydetail) ? $companydetail->email :
                                                ""}}</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <ul class="list-unstyled m-t-10">
                                            <li class="row">
                                                ...
                                                <p class="col font-weight-semibold">
                                                    <a
                                                        href="mailTo:{{isset($companydetail->email)? $companydetail->email:'' }}">{{isset($companydetail->email)?
                                                        $companydetail->email:'' }}</a>
                                                </p>
                                            </li>
                                            <li class="row">
                                                <p class="col-sm-4 col-4 font-weight-semibold text-dark m-b-5">
                                                ...
                                                <p class="col font-weight-semibold">
                                                    <a
                                                        href="tel:+123456789">{{isset($companydetail->contact_number)?$companydetail->contact_number:''}}</a>
                                                </p>
                                            </li>
                                        </ul>
                                    </div>
