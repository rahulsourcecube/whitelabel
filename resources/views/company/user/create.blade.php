                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="email" name="email"
                                    placeholder="Email Address" maxlength="150" value="{{ old('email') }}">
                                @error('email')
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    @error('ac_holder')
                                        <label id="ac_holder-error" class="error"
                                            for="ac_holder">{{ $message }}</label>
                                    @enderror
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    @error('ifsc_code')
                                        <label id="ifsc_code-error" class="error"
                                            for="ifsc_code">{{ $message }}</label>
                                    @enderror
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="ac_no">Account No</label>
                                    <input type="text" class="form-control" name="ac_no" id="ac_no"
                                        maxlength="11" minlength="11" placeholder="Account No" value="{{ old('ac_no') }}"
                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                                    @error('ac_no')
